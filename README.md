...
12.02. - ... ср  
  ...
  - 3) фото разрешением 2024х1024 пикселей занимает 2 Мбайта, сколько бит используется для кодирования цвета каждого пикселя и какова максимальная палитра цветов может быть?  
